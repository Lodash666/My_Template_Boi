...
@section('content')
    {{ html()->form('POST', route('admin.submenu.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                ...
                <div class="col">
                    <div class="form-group row">
                        <div class="col-md-2 form-control-label">
                            <label for="exampleFormControlSelect1">หัวข้อหลักของเมนู</label>
                        </div>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        {{ html()->label(__('validation.attributes.backend.access.menu.nameroute'))
                            ->class('col-md-2 form-control-label')
                            ->for('name') }}
                        ...
                        <div class="col-md-10">
                            {{ html()->text('nameroute')
                                ->class('form-control')
                                ->placeholder('Ex.admin.project.index')
                                ->attribute('maxlength', 191)
                                ->required()
                                ->autofocus() }}
                        </div><!--col-->
